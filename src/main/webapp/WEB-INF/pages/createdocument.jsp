...
<div class="container">
    ...
    <div class="row">
        <div class="span8 offset2">
            ...
            <form:form method="post" action="createdocument" modelAttribute="document" class="form-horizontal documentForm">
            ...
            <div class="control-group">
                <form:label cssClass="control-label" path="">Content:</form:label>
                <div class="controls">
